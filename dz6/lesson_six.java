...
2. Животные могут выполнять действия: бежать, плыть, перепрыгивать
препятствие. В качестве параметра каждому методу передается величина,
...
public class lesson_six {
    public static void main(String[] args) {
        ...
        System.out.println(dog.runAway(501, 200));
        System.out.println(dog.runAway(45,45));
        System.out.println(cat.runAway(2, 300));
        System.out.println(cat.sail(9, 2));
    }
}
